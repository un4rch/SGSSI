...
#texto_cifrado = texto_cifrado.upper() # En este caso no poner todo en mayusculas porque las "v" no estan cifradas
...
lista_cambios = { #En el examen rehacer esta lista después de la primera aproximación del descifrado deduciendo que letras pueden ser cuales en base a texto_descifrado
    "OLD": "new" #poner los cambios que se van a hacer en el texto parcialmente descifrado
}
